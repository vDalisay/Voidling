...
public partial class GardenDayNightDial : Control
{
    ...
    {
        // These are the existing lighting transition boundaries (5–9 dawn, 18–22 dusk).
        var hour = localTime.TimeOfDay.TotalHours;
        var key = hour < 5 || hour >= 22 ? "UI_GARDEN_NIGHT"
            : hour < 9 ? "UI_GARDEN_DAWN" : hour < 18 ? "UI_GARDEN_DAY" : "UI_GARDEN_DUSK";
