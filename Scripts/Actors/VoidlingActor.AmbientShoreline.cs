...
public partial class VoidlingActor
{
    ...
    /// toward the island shoreline; training movement is never affected.
    /// </summary>
    ...
    private void PickShorelineTarget()
    {
        ...
        // The modern Garden is an irregular cluster of buyable hex pieces. Clamp the rectangular
        // edge candidate back onto authored land so shoreline affinity cannot target water.
        _target = LandClamp?.Invoke(candidate) ?? candidate;
