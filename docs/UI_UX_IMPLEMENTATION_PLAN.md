...
- Added a 0.22-second sliding rail toggle centered on the rail edge. The Garden name/sprouts, day/night dial, Garden log, and save feedback slide away with the rail; the centered expand arrow remains on the left edge. Hidden navigation leaves keyboard traversal, and repeated clicks can reverse the slide.
